...
export default function Comparison() {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex flex-wrap items-start gap-x-8 gap-y-5">
          <Field label="Indicateur" htmlFor="c-indicateur">
            <Select value={params.indicateur} onValueChange={(v) => update({ indicateur: v })}>
              <SelectTrigger className="w-52" aria-labelledby="c-indicateur">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <Field label="Groupe" htmlFor="c-groupe">
            <Select
              ...
              disabled={isGini}
            >
              <SelectTrigger className="w-48" aria-labelledby="c-groupe">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                {groupeOptions.map((g) => (
      ...
      <div className="flex items-start gap-2.5 rounded-md border border-border bg-secondary px-4 py-3 text-[0.875rem] text-foreground">
